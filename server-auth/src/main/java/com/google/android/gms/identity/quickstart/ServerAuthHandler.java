...
public class ServerAuthHandler implements GoogleApiClient.ServerAuthCodeCallbacks {
    ...
    private static final String SERVER_BASE_URL = "http://go-actiwe.appspot.com";
    ...
    // URL where the client should GET the answer to whether the user is registered
    private static final String LOOKUP_USER_URL = SERVER_BASE_URL + "/lookupuser";
    ...
    public CheckResult onCheckServerAuthorization(String idToken, Set<Scope> scopeSet) {
        ...
        if (!serverHasToken) {
            ...
            HashSet<Scope> serverScopeSet = new HashSet<>();
    ...
    public boolean onUploadServerAuthCode(String idToken, String serverAuthCode) {
        Log.i(TAG, "onUploadServerAuthCode: " + serverAuthCode);
   ...
   public void checkServerAuthConfiguration(String webClientId) {
       Log.i(TAG, "checkServerAuthConfiguration: " + webClientId);
    ...
    private boolean serverHasTokenFor(String idToken) {
        Log.i(TAG, "serverHasTokenFor: "+ idToken);
        HttpClient httpClient = new DefaultHttpClient();
        ...
        try{
            ...
            nameValuePairs.add(new BasicNameValuePair("idToken", idToken));
            URI uri = new URI(LOOKUP_USER_URL + "?" + URLEncodedUtils.format(nameValuePairs, "utf-8"));
    ...
    public void setServerHasToken(boolean serverHasToken) {
        boolean mServerHasToken = serverHasToken;
    }
